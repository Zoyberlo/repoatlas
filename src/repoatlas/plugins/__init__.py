...
The rules live in `conventions.json` rather than in code. There are two
frameworks in it today and there will be more; each is a few lines of
description, and none of them needs a branch. Adding one is editing a file.
"""

from __future__ import annotations

from .base import FrameworkPlugin, active_plugins, register, registered_plugins
from .registry import ConventionPlugin, Framework, load_registry, registry_source
